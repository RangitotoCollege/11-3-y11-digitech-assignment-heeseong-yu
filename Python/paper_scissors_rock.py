...
def play():
    ...
    while playing:
        ...
        # Prevent user from tricking the computer to use basically only one
        # hand.
        ...
        # Also adds the base set of hands.
        ...
        # Check one way then other way around.
        # If there is no values from checking the winner, it's a tie.
        winner = rules.get(
        ...
        # Just a little delay to prvent user from spamming.
        time.sleep(0.5)
    return
