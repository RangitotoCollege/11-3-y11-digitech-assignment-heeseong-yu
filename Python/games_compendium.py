...
wordle_words_list = [
    ...
    'leave', 'legal', 'level', 'lewis', 'light', 'limit', 'links', 'lives', 'living', 'local',
    ...
    'rapid', 'ratio', 'reach', 'react', 'ready', 'realm', 'rear', 'rebel', 'refer', 'relax',
    ...
    'stare', 'start', 'state', 'static', 'steal', 'steam', 'steel', 'steep', 'steer', 'stick',
    ...
    'abbot', 'abhor', 'abide', 'abled', 'abode', 'abort', 'abound', 'abroad', 'abrupt', 'absent',
    'absorb', 'absurd', 'accent', 'accept', 'access', 'accord', 'accuse', 'ached', 'acorn',
    'across', 'acting', 'action', 'active', 'actual', 'acumen', 'adapt', 'added', 'addict',
    'adept', 'adieu', 'adjust', 'admire', 'adorn', 'adrift', 'adverb', 'advert', 'afoot', 'afore',
    'afoul', 'afresh', 'after', 'agape', 'agile', 'aging', 'aglow', 'agony', 'agora', 'agree',
